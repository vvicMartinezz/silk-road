...
{% include scrollybox/bg.html
  ...
  box-content=' These earrings of the Silla offers a romaticized view of the Silk Road trade network.'
%}
...
{% include typography/aside.html class="left" text="the triskele… may refer to the sanctity of the number three and was possibly also associated with the sun." %}
...
{% include images/figure.html class="right" width="60%" caption="This image A closer look at these pretty golden earrings from Silla. [Source](https://www.metmuseum.org/art/collection/search/44813)" image-path="images/Korean.jpg" %}
...
- Bang, Sun. "Re-contextualised transcultural artwork: re-imagining pattern and symbol of the nomadic relic in the digital era." PhD diss., RMIT University, 2024.